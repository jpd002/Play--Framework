...
namespace Framework
{
	namespace Win32
	{
		...
		private:
			...
			Framework::Win32::CPropertyGridListBox::StartEditionEvent::CConnectionPtr m_StartEditionConnection;
			Framework::Win32::CPropertyGridEdit::EditCompletedEvent::CConnectionPtr m_EditCompletedConnection;
		};
	}
}
